...
export function CommandPalette({
  ...
  const { documents, setActiveDocId, addDocument, theme, toggleTheme } =
    useAppStore();
  ...
  const handleNewDoc = () => {
    ...
    addDocument(doc);
    track("doc_create", { docType: "markdown", source: "command_palette" });
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Panels">
            <CommandItem
              onSelect={() => handleSelect(() => onTogglePanel("ai"))}
            >
              <Bot className="mr-2 h-4 w-4" />
              Toggle AI Panel
            </CommandItem>
            <CommandItem
              onSelect={() => handleSelect(() => onTogglePanel("versions"))}
            >
          ...
          <CommandGroup heading="Actions">
            ...
            {onOpenShareLink && (
              <CommandItem
                onSelect={() => handleSelect(() => setLinkInputOpen(true))}
              >
