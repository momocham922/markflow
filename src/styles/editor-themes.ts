...
const nordLight = EditorView.theme(
  {
    ...
    ".cm-header-2": {
      fontSize: "1.35em",
      fontWeight: "600",
      color: "oklch(0.53 0.09 210)",
    },
    ".cm-header-3": {
      fontSize: "1.15em",
      fontWeight: "600",
      color: "oklch(0.55 0.08 190)",
    },
...
const tokyoNightLight = EditorView.theme(
  {
    ...
    ".cm-header-1": {
      fontSize: "1.6em",
      fontWeight: "700",
      color: "oklch(0.5 0.18 265)",
    },
    ".cm-header-2": {
      fontSize: "1.35em",
      fontWeight: "600",
      color: "oklch(0.53 0.15 240)",
    },
    ".cm-header-3": {
      fontSize: "1.15em",
      fontWeight: "600",
...
const gruvboxLight = EditorView.theme(
  {
    ...
    ".cm-header-2": {
      fontSize: "1.35em",
      fontWeight: "600",
      color: "oklch(0.52 0.14 130)",
    },
    ".cm-header-3": {
      fontSize: "1.15em",
      fontWeight: "600",
      color: "oklch(0.54 0.12 90)",
    },
